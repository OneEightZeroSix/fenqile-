...
class XmainFoot extends Component {
	...
	render() {
		return(
			<div id="newgoodslist">
				<WingBlank>
		        <Carousel autoplay={true} infinite beforeChange={(from, to) => console.log(`slide from ${from} to ${to}`)} afterChange={index => console.log('slide to', index)} style={{height:'180px', margin:'20px 0',background:'#fff',width:'100%',position:'absolute',left:'0'	}}>
