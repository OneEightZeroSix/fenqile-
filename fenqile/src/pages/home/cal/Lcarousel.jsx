...
class Lcarousel extends Component {
    ...
    render() {
        ...
        <div id="Lcarousel_container">
            <Carousel autoplay>
                <div>
                    <div style={{textAlign:'center',boxSizing:'border-box', marginLeft: '1.6vw', width: '100%', height: '415px',paddingTop:'60px', background: 'url(https://cimg1.fenqile.com/ibanner2/M00/03/8A/jagHAFpwYE2AAyk4AANixPGbA-M464.png) no-repeat', backgroundSize: 'contain' }}>
                ...
                <div>
                    <div style={{paddingTop:'60px',textAlign:'center',boxSizing:'border-box', marginLeft: '1.6vw', width: '100%', height: '415px', background: 'url(https://cimg1.fenqile.com/ibanner2/M00/00/A0/jagHAFpm9eKAdBGdAAIYMeGTRbo890.png) no-repeat', backgroundSize: 'contain' }}>
                ...
                <div>
                    <div style={{ paddingTop:'60px',textAlign:'center',boxSizing:'border-box',marginLeft: '1.6vw', width: '100%', height: '415px', background: 'url(https://cimg1.fenqile.com/ibanner2/M00/00/A0/jagHAFpm9fCAdijtAANftDA-XGg878.png) no-repeat', backgroundSize: 'contain' }}>
                ...
                <div>
                    <div style={{paddingTop:'60px',textAlign:'center',boxSizing:'border-box', marginLeft: '1.6vw', width: '100%', height: '415px', background: 'url(https://cimg1.fenqile.com/ibanner2/M00/00/A0/jagHAFpm9a-AOkLgAAGqmmQTNFA402.png) no-repeat', backgroundSize: 'contain' }}>
