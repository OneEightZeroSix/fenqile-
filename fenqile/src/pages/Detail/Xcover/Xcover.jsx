					    ...
					    this.setState({
				    ...
				    }}>
					        {
					        	this.state.goodsPic.map(function(item,idx){
					    			return <span data-index="0" key={idx} style={{height: '100%',width:'100%',position:'absolute'}}>
						                	<img src={`${item.split("?")[0]}`} alt="" style={{width:'100%',position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)' }}/>
						            		</span>
					          	})
					        }
				    </Tabs>
